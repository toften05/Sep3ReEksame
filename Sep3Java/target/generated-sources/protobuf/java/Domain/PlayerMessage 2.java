...
/**
 * Protobuf type {@code Domain.PlayerMessage}
 */
public final class PlayerMessage extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:Domain.PlayerMessage)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Domain.FootballManagement.internal_static_Domain_PlayerMessage_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Domain.FootballManagement.internal_static_Domain_PlayerMessage_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            Domain.PlayerMessage.class, Domain.PlayerMessage.Builder.class);
  }
  ...
  public static final int ROLLE_FIELD_NUMBER = 5;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getRolleBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 5, rolle_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!getRolleBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(5, rolle_);
    }
    if (!getTeamNameBytes().isEmpty()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof Domain.PlayerMessage)) {
      return super.equals(obj);
    }
    Domain.PlayerMessage other = (Domain.PlayerMessage) obj;
  ...
  public static Domain.PlayerMessage parseFrom(
  ...
  public static Domain.PlayerMessage parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static Domain.PlayerMessage parseFrom(
  ...
  public static Domain.PlayerMessage parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Domain.PlayerMessage parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static Domain.PlayerMessage parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(Domain.PlayerMessage prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:Domain.PlayerMessage)
      Domain.PlayerMessageOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Domain.FootballManagement.internal_static_Domain_PlayerMessage_descriptor;
    }
    ...
    // Construct using Domain.PlayerMessage.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public Domain.PlayerMessage getDefaultInstanceForType() {
      return Domain.PlayerMessage.getDefaultInstance();
    }

    @java.lang.Override
    public Domain.PlayerMessage build() {
      Domain.PlayerMessage result = buildPartial();
    ...
    @java.lang.Override
    public Domain.PlayerMessage buildPartial() {
      Domain.PlayerMessage result = new Domain.PlayerMessage(this);
      result.id_ = id_;
      result.name_ = name_;
      if (birthdayBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof Domain.PlayerMessage) {
        return mergeFrom((Domain.PlayerMessage)other);
      } else {
    ...
    public Builder mergeFrom(Domain.PlayerMessage other) {
      if (other == Domain.PlayerMessage.getDefaultInstance()) return this;
      if (other.getId() != 0) {
        setId(other.getId());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Domain.PlayerMessage parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (Domain.PlayerMessage) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:Domain.PlayerMessage)
  }

  // @@protoc_insertion_point(class_scope:Domain.PlayerMessage)
  private static final Domain.PlayerMessage DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new Domain.PlayerMessage();
  }

  public static Domain.PlayerMessage getDefaultInstance() {
