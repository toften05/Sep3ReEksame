...
public final class CoachServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Domain.AllCoachesRequest,
      Domain.ListCoachMessage> getGetAllCoachesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAllCoaches",
      requestType = Domain.AllCoachesRequest.class,
      responseType = Domain.ListCoachMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Domain.AllCoachesRequest,
      Domain.ListCoachMessage> getGetAllCoachesMethod() {
    io.grpc.MethodDescriptor<Domain.AllCoachesRequest, Domain.ListCoachMessage> getGetAllCoachesMethod;
    if ((getGetAllCoachesMethod = CoachServiceGrpc.getGetAllCoachesMethod) == null) {
      synchronized (CoachServiceGrpc.class) {
        if ((getGetAllCoachesMethod = CoachServiceGrpc.getGetAllCoachesMethod) == null) {
          CoachServiceGrpc.getGetAllCoachesMethod = getGetAllCoachesMethod =
              io.grpc.MethodDescriptor.<Domain.AllCoachesRequest, Domain.ListCoachMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAllCoaches"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Domain.AllCoachesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Domain.ListCoachMessage.getDefaultInstance()))
              .setSchemaDescriptor(new CoachServiceMethodDescriptorSupplier("getAllCoaches"))
              .build();
        }
      }
    }
    return getGetAllCoachesMethod;
  }
  ...
  public static abstract class CoachServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAllCoaches(Domain.AllCoachesRequest request,
        io.grpc.stub.StreamObserver<Domain.ListCoachMessage> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAllCoachesMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getGetAllCoachesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                Domain.AllCoachesRequest,
                Domain.ListCoachMessage>(
                  this, METHODID_GET_ALL_COACHES)))
          .build();
    }
  }
  ...
  public static final class CoachServiceStub extends io.grpc.stub.AbstractAsyncStub<CoachServiceStub> {
    ...
    public void getAllCoaches(Domain.AllCoachesRequest request,
        io.grpc.stub.StreamObserver<Domain.ListCoachMessage> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetAllCoachesMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CoachServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CoachServiceBlockingStub> {
     ...
     * </pre>
     */
    public Domain.ListCoachMessage getAllCoaches(Domain.AllCoachesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetAllCoachesMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CoachServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CoachServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<Domain.ListCoachMessage> getAllCoaches(
        Domain.AllCoachesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetAllCoachesMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_CREATE_COACH = 0;
  private static final int METHODID_GET_ALL_COACHES = 1;
      ...
      switch (methodId) {
        case METHODID_CREATE_COACH:
          serviceImpl.createCoach((Domain.CoachCreationDtoMessage) request,
              (io.grpc.stub.StreamObserver<Domain.CoachMessage>) responseObserver);
          break;
        case METHODID_GET_ALL_COACHES:
          serviceImpl.getAllCoaches((Domain.AllCoachesRequest) request,
              (io.grpc.stub.StreamObserver<Domain.ListCoachMessage>) responseObserver);
          break;
        default:
      ...
      synchronized (CoachServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetAllCoachesMethod())
              .build();
        }
      }
    }
